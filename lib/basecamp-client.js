...
class BasecampClient {
  ...
  getTodos(basecamp_id, todolist_id) {
    return this.accountId
      .then(accountId => "https://3.basecampapi.com/" + accountId + "/buckets/" + basecamp_id + "/todolists/" + todolist_id +"/todos.json")
      .then((url) => this._basecampRequest(url))
  }

  getComments(basecamp_id, recording_id) {
    return this.accountId
      .then(accountId => "https://3.basecampapi.com/" + accountId + "/buckets/" + basecamp_id + "/recordings/" + recording_id +"/comments.json")
      .then((url) => this._basecampRequest(url))
  }
